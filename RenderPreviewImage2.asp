<% @language = "JavaScript" %><!--#include file="fileio.asp"--><% 
	...
	//wsh.Run (Server.MapPath ("/AnimOv/anim.exe") + " -llc " + Server.MapPath ("/AnimOv/data/llc" + id + ".llc") + " -aoc " + 
	//	Server.MapPath ("/AnimOv/data/id" + id + ".aoc") + " -mps id" + id + " -png " + Server.MapPath ("/AnimOv/data/png" + id + "_") + " -w " + 
	//	main_w + " -h " + main_h + " -start " + (i + 1) + " -stop " + (i + 1) + " -outline 1"); 
	wsh.Run (Server.MapPath ("/AnimOv/anim.exe") + 
		" -llc data/llc" + id + ".llc -aoc data/id" + id + ".aoc -mps id" + id + " -png data/png" + id + "_ -w " + main_w + " -h " + 
		main_h + " -start " + (i + 1) + " -stop " + (i + 1) + " -outline 1", 0, true); 
	file_put_contents (Server.MapPath ("/AnimOv/last_call.txt"), Server.MapPath ("/AnimOv/anim.exe") + 
		" -llc data/llc" + id + ".llc -aoc data/id" + id + ".aoc -mps id" + id + " -png data/png" + id + "_ -w " + main_w + " -h " + 
		main_h + " -start " + (i + 1) + " -stop " + (i + 1) + " -outline 1"); 
	//for (; i < c; i++){ 
